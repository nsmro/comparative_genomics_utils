...
def assign_ids_to_pair(AN1, AN2, Dict_AN):# the problem is somewhere there. Out of 4 transcripts, the last one gets fucked up with the ID
...
if __name__ == "__main__":
	...
	parser.add_argument("-r", "--ref_filter", help = "OPTIONNAL: reference file for filtering. files are either 'fasta' file or 'clus'.", choices = ['fasta','clus'], default = None)
	parser.add_argument("-F", "--filter_file", help = "File to be used for filtering", default = None)
	parser.add_argument("-S", "--suffix", help = "suffix found in the accessions of the fasta but absent of the gff, e.g. _1. Use is your proteins are from transdecoder.", default = '')
